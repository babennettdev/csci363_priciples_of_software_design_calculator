...
//including <cstring for the size_t definition
#include <cstring>
...
private:
  ...
  // Ryan: Are these necessary since we have the Array?
  // Fixed: Removed bottom and top of stack variables, will use arr->size() to track the top of the stack
};
